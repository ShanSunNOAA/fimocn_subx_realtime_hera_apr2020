...
$year2 = ($year2 + 1900);
$mon2++;
my $lastChecked = sprintf("%02d/%02d/%04d %02d:%02d Z",$mon2,$mday2,$year2,$hour2,$min2);

print <<EOF;
Content-Type: text/html

<!--#set var="page_title" value="FIM Run Status (zeus)" -->
<!--#set var="refresh" value="refresh" -->
<!--#set var="fieldTableWidth" value="85em" -->
<!--#set var="bodyWidth" value="95em" -->
...
# print "<th class=\"FIMstatusHdr\">FIM<br> Last <br>Fcst Hr</th>";
print "<th class=\"FIMcompleteHdr\">FIMZEUS Run<br>Complete</th>";
print "<th class=\"FIMstatusHdr\">FIMZEUS<br> Last<br>Fcst Hr</th>";
# print "<th class=\"FIMcompleteHdr\">FIM7 Run<br>Complete</th>";
# print "<th class=\"FIMstatusHdr\"> FIM7<br> Last <br>Fcst Hr</th>";
print "<th class=\"FIMcompleteHdr\"> FIM9ZEUS Run<br>Complete</th>";
print "<th class=\"FIMstatusHdr\"> FIM9ZEUS<br> Last <br>Fcst Hr</th>";
# print "<th class=\"FIMcompleteHdr\"> FIMX Run<br>Complete</th>";
# print "<th class=\"FIMstatusHdr\"> FIMX<br> Last<br>Fcst Hr</th>";
print "<th class=\"FIMcompleteHdr\"> FIMXZEUS Run<br>Complete</th>";
print "<th class=\"FIMstatusHdr\"> FIMXZEUS<br> Last<br>Fcst Hr</th>";
print "</tr>";

my $count = 0;
for my $r (@runs) {
    # my ($fimRunString,$fimEndTime,$fimLastFcst,$fimxEndTime,$fimxLastFcst,$fimyEndTime,$fimyLastFcst,
    my ($runTime, $fimRunString,$fimEndTime,$fimLastFcst,$fimzeusEndTime,$fimzeusLastFcst,$fim7EndTime,$fim7LastFcst,
        $fim9zeusEndTime,$fim9zeusLastFcst,$fimxEndTime,$fimxLastFcst,$fimxzeusEndTime,$fimxzeusLastFcst) = split /\|/, $r;
#   print " ($runTime, $fimRunString,$fimEndTime,$fimLastFcst,$fimxEndTime,$fimxLastFcst,$fimyEndTime,$fimyLastFcst,$fim7EndTime,$fim7LastFcst,$fimzEndTime,$fimzLastFcst,$fim9EndTime,$fim9LastFcst<br>\n";
   ...
   print "<td class=\"fieldNameFIMstatus\">$fimzeusEndTime</td>\n";
   print "<td class=\"fieldNameFIMstatus\">$fimzeusLastFcst</td>\n";
   # print "<td class=\"fieldNameFIMstatus\">$fim7EndTime</td>\n";
   # print "<td class=\"fieldNameFIMstatus\">$fim7LastFcst</td>\n";
   print "<td class=\"fieldNameFIMstatus\">$fim9zeusEndTime</td>\n";
   print "<td class=\"fieldNameFIMstatus\">$fim9zeusLastFcst</td>\n";
   # print "<td class=\"fieldNameFIMstatus\">$fimxEndTime</td>\n";
   # print "<td class=\"fieldNameFIMstatus\">$fimxLastFcst</td>\n";
   print "<td class=\"fieldNameFIMstatus\">$fimxzeusEndTime</td>\n";
   print "<td class=\"fieldNameFIMstatus\">$fimxzeusLastFcst</td>\n";
   print "</tr>\n";
}
print "</TABLE>\n";
print <<EOF;
