...
if os.path.isfile(input_dir+b15+'00/fim9block.png') :
...
#  os.utime(lockfiles_dir+'mv_hrrr_test.lock', None)
    ...
    print mkdir_cmd 
    os.system(mkdir_cmd)
    sync_cmd = 'rsync -avz '+input_dir+b15+'00/fim9block.png ratchet:' + output_dir+b15+'/full/block_f00.png --delete --rsh=ssh'
    print sync_cmd
    os.system(sync_cmd)
