...
##  purgeGrib1.pl 
##
##    01 Feb 2014 - J.K. Henderson
##                  started with purgeFiles.pl
##
...
my @rootDirs = ("$fimHome/FIM/", "$fimHome/FIM9/", "$fimHome/FIMZ/", "$fimHome/FIM95/", "$fimHome/FIMY/");
my @runDirs = ("fim_8","fim_9","fim_8", "fim_9", "fim_8");
