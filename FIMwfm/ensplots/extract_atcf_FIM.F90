...
DATA cmem /'01','02','03','04','05','06','07','08','09','10'/
...
CALL getarg (5, plotPath)   
CALL getarg (6, glvl_in)   
CALL getarg (7, fcst_len_in)   
CALL getarg (8, fcst_output_int_in)   
...
cdir = TRIM(rundir_in) // '/tracker_' // TRIM(cmem) // '/' // TRIM(fcst_len_in)
