...
# archive=${YEAR}${MONTH}/cfsv2_${YEAR}${MONTH}${DAY}${HOUR}.tar
# echo "IC tar is ${MASS_CFS_IC_DIR}/${archive} "
# hsi get ${MASS_CFS_IC_DIR}/${archive}
# status=$?
# if [ $status != 0 ]; then
#   echo "error $status retrieving tar file $MASS_CFS_IC_DIR/${archive}"
#   return $status
# fi
