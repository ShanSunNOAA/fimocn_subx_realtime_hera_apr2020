...
!   ishal_cnv        : shallow convection scheme flag                   !
!                     =0:  no shallow convection
!                     =1: SAS shallow convection
!                     =2:  GF shallow convection
!                     =3: both SAS and GF shallow convection
!   ideep_cnv        : deep convection scheme flag                      !
!                     =0:  no deep convection
!                     =1: SAS deep convection
!                     =2:  GF deep convection
...
!
     ...
     &            kind_phys
      ...
      use namelist_def , only : n3dfercld
      use fimnamelist  , only : n3dzhaocld, n3dcldpdf
!
      implicit   none
...
!  ---  input:
     ...
     &       isubc_sw, isubc_lw, iflip, me, idate(4)
      ...
      integer, intent(in) :: ishal_cnv,ideep_cnv
...
!       ipsd0 = 17*idate(1)+43*idate(2)+37*idate(3)+23*idate(4) + ipsd0
     ...
     &          ' n3dcldpdf=',n3dcldpdf
        print *,'shallow conv (0=none; 1=SAS; 2=GF; 3=SAS&GF) uses ',   &
     &           ishal_cnv
        print *,'deep conv (0=none; 1=SAS; 2=GF) uses ',ideep_cnv
      endif
