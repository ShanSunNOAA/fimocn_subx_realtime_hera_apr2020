...
!JR Moved to lwrad local for OMP
!JR      logical :: lhlwb  = .false.
!JR      logical :: lhlw0  = .false.
!JR      logical :: lflxprf= .false.
...
!  ---  inputs:
     ...
     &       fracs,secdiff,nlay,nlp1, lhlw0, lhlwb,                     &
!  ---  outputs:
...
!  ---  inputs:
     &     ( semiss,delp,cldfrc,taucld,tautot,pklay,pklev,              &
     &       fracs,secdif, nlay,nlp1, lhlw0, lhlwb,                     &
!  ---  outputs:
     &       totuflux,totdflux,htr, totuclfl,totdclfl,htrcl, htrb       &
     &     )
