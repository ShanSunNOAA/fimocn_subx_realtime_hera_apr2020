...
! hli 09/2014
    real(kind=kind_phys),pointer:: SFCUSW(:,:)=>null()
    real(kind=kind_phys),pointer:: SFCULW(:,:)=>null()
    real(kind=kind_phys),pointer:: TOPDSW(:,:)=>null()
    real(kind=kind_phys),pointer:: TOPUSW(:,:)=>null()
    real(kind=kind_phys),pointer:: TOPULW(:,:)=>null()
