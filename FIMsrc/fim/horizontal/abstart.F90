...
if (its == 1 .or. (its==itsDFI.and.digifilt)) then
  adbash1 = dt
  adbash2 = 0.
  adbash3 = 0.
endif

if (its == 2 .or. (its==itsDFI+1.and.digifilt)) then
  adbash1 = dt*1.5
  adbash2 = -dt*.5
  adbash3 = 0.
endif

if (its == 3 .or. (its==itsDFI+2.and.digifilt)) then
  adbash1 = dt*23./12.
  adbash2 = -dt*16./12.
  adbash3 = dt*5./12.
endif
