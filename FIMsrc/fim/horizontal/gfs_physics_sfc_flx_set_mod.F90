...
! jbao new gfs phys
           ...
           sfc_fld%stress (dim1s:dim1e,dim2),     &
...
!          flx_fld%BENGSH  (dim1s:dim1e,dim2), &   !JR This field is used nowhere
...
! hli 09/2014
          flx_fld%SFCUSW  (dim1s:dim1e,dim2), &
          flx_fld%SFCULW  (dim1s:dim1e,dim2), &
          flx_fld%TOPDSW  (dim1s:dim1e,dim2), &
          flx_fld%TOPUSW  (dim1s:dim1e,dim2), &
          flx_fld%TOPULW  (dim1s:dim1e,dim2), &
...
!         flx_fld%SOILM   (dim1s:dim1e,dim2), &
    ...
    integer,intent(in)::iret ! change to 'intent(out)' if/when actually set
    ...
    flx_fld%RAINC   = 0.
!    flx_fld%BENGSH  = 0.            !JR This field is used nowhere
    flx_fld%DUSFC   = 0.
    flx_fld%DVSFC   = 0.
    flx_fld%DTSFC   = 0.
    flx_fld%DQSFC   = 0.
