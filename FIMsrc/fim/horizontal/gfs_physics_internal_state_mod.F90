...
!
      ...
      integer :: num_p3d = 4   !JR Probably should not duplicate the setting from namelist_def here
      logical :: ras=.false.   !JR Probably should not duplicate the setting from namelist_def here
      integer lats_node_r
...
! jbao added for gfs 2014
      REAL(KIND=KIND_RAD) ,ALLOCATABLE :: SWHC(:,:,:,:),HLWC(:,:,:,:)
! jbao added for gfs 2014
...
!TODO:  move this elsewhere...
      TYPE(gfs_physics_internal_state), pointer :: gis_phy => null()
