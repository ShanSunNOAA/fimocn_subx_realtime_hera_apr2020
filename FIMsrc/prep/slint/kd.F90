...
MODULE kd
     ...
     REAL :: nns_radius = 10.0    !defaul nns radius value in radian
...
END SUBROUTINE Set_nns_radius

REAL FUNCTION Get_nns_radius()
    IMPLICIT NONE

    Get_nns_radius = nns_radius

END FUNCTION Get_nns_radius
