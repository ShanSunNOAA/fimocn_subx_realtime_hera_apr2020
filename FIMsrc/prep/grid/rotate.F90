...
SUBROUTINE rotate(theta,lambda,topgrid, n)
     ...
     REAL(KIND=8) :: theta, lambda
     INTEGER :: n
     TYPE(GridPointWnb) :: topgrid(n)

     REAL(KIND=8) :: pi, d2r, cos_t, sin_t, cos_l, sin_l
     REAL(KIND=8) :: latlon(2)
     INTEGER :: i, j
...
SUBROUTINE rotate_latlon(latlon, sin_t, cos_t, sin_l, cos_l)
     IMPLICIT NONE
     REAL(KIND=8) :: latlon(2), sin_t, cos_t, sin_l, cos_l
     REAL(KIND=8) :: xyz(3), xyz1(3), xyz2(3)
     REAL(KIND=8) :: pi, c11, c12, c13, c21, c22, c23, c31, c32, c33
