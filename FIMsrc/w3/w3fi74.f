...
C   07-08-30  N. WANG     ADDED TYPE 12--ICOSAHEDRAL HEXAGONAL GRID
...
C
     ...
     &    IGDS(3) .EQ. 204.OR.  IGDS(3) .EQ. 12) THEN
          LENGDS = 32
C
...
C
 ...
 10       CONTINUE
        END IF
C
C$$     PROCESS ICOSAHEDRAL HEXAGONAL GRID TYPES
C             ADDED ON 07-08-30, N. W.
C     
      ELSE IF (IGDS(3) .EQ. 12) THEN
        GDS( 7) = CHAR(MOD(IGDS(4)/256,256))
        GDS( 8) = CHAR(MOD(IGDS(4)    ,256))
        GDS( 9) = CHAR(MOD(IGDS(5)/256,256))
        GDS(10) = CHAR(MOD(IGDS(5)    ,256))
...
C       Di, Dj --NOT GIVEN
        ...
        GDS(26) = CHAR(255)
        GDS(27) = CHAR(255)
C       OCTET 28 -- CURVE TYPE, OCTET 29 -- GRID REFINEMENT LEVELS
        GDS(28) = CHAR(IGDS(13))
        GDS(29) = CHAR(IGDS(14))
        GDS(30) = CHAR(0)
        GDS(31) = CHAR(0)
