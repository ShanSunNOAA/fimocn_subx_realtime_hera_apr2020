...
integer       :: stepchem
integer       :: stepfirepl
character*256 :: emi_inname = "fimemi"
character*256 :: fireemi_inname = "fimfireemi"
character*256 :: input_chem_inname = "fim_chem_input"
character*256 :: emi_outname = " "
character*256 :: fireemi_outname = " "
character*256 :: input_chem_outname = " "
integer       :: frames_per_emissfile = 1
integer       :: frames_per_fireemissfile = 1
integer       :: io_style_emissions = 0
integer       :: io_form_emissions = 0
...
integer       :: nmegan = 138
integer       :: kfuture = 1
integer       :: errosion_dim = 3
integer       :: biomass_emiss_opt
integer       :: chem_conv_tr = 1
integer       :: chem_opt=0
...
integer       :: aer_op_opt = 1
integer       :: scalar_opt
! next is wrfphys, set defaults
!
integer       :: mp_physics = 0
integer       :: gsfcgce_hail = 0
integer       :: gsfcgce_2ice = 0
integer       :: progn = 0
integer       :: ra_lw_physics = 0
integer       :: ra_sw_physics = 0
real          :: radt = 0
real          :: naer = 1e9
integer       :: sf_sfclay_physics = 0
integer       :: sf_surface_physics = 0
integer       :: bl_pbl_physics = 0
integer       :: sf_urban_physics = 0
real          :: bldt = 0
integer       :: cu_physics = 0
real          :: cudt = 0
real          :: gsmdt = 0
integer       :: isfflx = 1
integer       :: ifsnow = 0
integer       :: icloud = 1
real          :: swrad_scat = 1
integer       :: surface_input_source = 1
integer       :: num_urban_layers = 400
...
integer       :: maxens3 = 16
integer       :: ensdim = 144
integer       :: cugd_avedx = 1
integer       :: imomentum = 0
integer       :: clos_choice = 0
integer       :: num_land_cat = 24
integer       :: num_soil_cat = 16
integer       :: mp_zero_out = 0
real          :: mp_zero_out_thresh = 1.e-8
real          :: seaice_threshold = 271
integer       :: sst_update = 0
integer       :: sst_skin = 0
integer       :: tmn_update = 0
logical       :: usemonalb = .false.
logical       :: rdmaxalb = .true.
logical       :: rdlai2d = .false.
integer       :: co2tf = 1
integer       :: ra_call_offset = 0
real          :: cam_abs_freq_s = 21600.
integer       :: levsiz = 1
integer       :: paerlev = 1
integer       :: cam_abs_dim1 = 1
integer       :: cam_abs_dim2 = 1
integer       :: lagday = 1
logical       :: cu_rad_feedback = .false.
integer       :: pxlsm_smois_init = 1
integer       :: omlcall = 0
real          :: oml_hml0 = 50
real          :: oml_gamma = 0.14
integer       :: isftcflx = 0
real          :: shadlen = 25000.
integer       :: slope_rad = 0
integer       :: topo_shading = 0
integer       :: no_mp_heating = 0
integer       :: fractional_seaice = 0
real          :: bucket_mm = -1.
real          :: bucket_j = -1.
